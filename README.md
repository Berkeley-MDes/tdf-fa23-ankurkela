...
I did not consult in design specialist since I was running out of time but I would do so next time. My suspicion was that the laser might not have been as sharp, as my classmates used the same settings and were able to get a proper cut. Anyway, I decided to just use a regular. 

Fortunately, I was able to get help from a few other classmates who suggested some tips on how to properly export files from Adobe Illustrator 
